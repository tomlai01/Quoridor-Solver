...
class TestState(unittest.TestCase):
    ...
    def test_exists_solution_2(self):
        self.assertTrue(self.state2.exists_solution({i:[] for i in range(2)}))
        self.state2.h_walls.add((4, 4))
        self.assertTrue(self.state2.exists_solution({i:[] for i in range(2)}))
        ...
        self.assertFalse(self.state2.exists_solution({i:[] for i in range(2)}))

    def test_can_place_2(self):
        # horizontal wall tests
        self.state2.h_walls.add((4, 4))
        self.assertTrue(self.state2.can_place(True, (3,3), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(False, (3, 3), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(False, (4, 4), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(True, (3, 4), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(True, (4, 3), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(True, (5, 4), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(True, (4, 5), {i:[] for i in range(2)}))
        self.state2.h_walls.remove((4, 4))
        # vertical wall tests
        self.state2.v_walls.add((4, 4))
        self.assertTrue(self.state2.can_place(False, (3, 3), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(True, (3, 3), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(True, (4, 4), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(False, (4, 3), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(False, (3, 4), {i:[] for i in range(2)}))
        self.assertTrue(self.state2.can_place(False, (4, 5), {i:[] for i in range(2)}))
        self.assertFalse(self.state2.can_place(False, (5, 4), {i:[] for i in range(2)}))
        self.state2.v_walls.remove((4, 4))
        # no solutions
        self.state2.v_walls.add((0, 3))
        self.state2.v_walls.add((0, 4))
        self.assertFalse(self.state2.can_place(True, (1, 4), {i:[] for i in range(2)}))
        self.state2.v_walls.remove((0, 3))
        self.assertTrue(self.state2.can_place(False, (0, 3), {i:[] for i in range(2)}))
        self.state2.h_walls.add((1, 4))
        self.assertFalse(self.state2.can_place(False, (0, 3), {i:[] for i in range(2)}))
